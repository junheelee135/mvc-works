...
import com.mvc.app.mapper.BoardMapper;
...
public class BoardServiceImpl implements BoardService {
	...
	@Override
	public void deleteBoard(long num, String uploadPath, String empId, int userLevel) throws Exception {
		try {
			BoardDto dto = Objects.requireNonNull(findById(num));
			if (userLevel < 51 && !dto.getEmpId().equals(empId)) {
				return;
			}
