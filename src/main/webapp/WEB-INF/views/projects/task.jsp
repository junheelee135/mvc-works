...
.flatpickr-prev-month::after { content:'<'; }
						        ...
						        <c:when test="${not empty list}">
						            <c:forEach var="t" items="${list}" varStatus="status">
						                ...
						                <td class="text-center">
											<input type="date" class="cell-date" value="${t.taskStartDate}" ${isManager ? '' : 'disabled'} 
												data-task-id="${t.taskId}" data-type="startDate">
						                </td>
						                <td class="text-center">
						                    <input type="date" class="cell-date" value="${t.taskEndDate}" ${isManager ? '' : 'disabled'}
												data-task-id="${t.taskId}" data-type="endDate">
						                </td>
						                <td>
