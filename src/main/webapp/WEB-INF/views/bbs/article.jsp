		...
		<div class="container" data-aos="fade-up" data-aos-delay="100">
			<div class="row justify-content-center">
				<div class="col-md-10 board-section my-4 p-5">
					...
					<div class="reply-session" data-num="${dto.num}" 
							data-postsUrl="${pageContext.request.contextPath}/posts/bbsReply"
							data-contextPath="${pageContext.request.contextPath}">
						<jsp:include page="/WEB-INF/views/posts/replyContent.jsp"/>
					</div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // 댓글 / 답글 신고
    const replySessionEL = document.querySelector('.reply-session');
    if (replySessionEL) {
